...
removedValue = supplyChanges.pop();
console.log( 'Removed mistake number of', removedValue );
...
for(let i = 0; i < supplyChanges.length; i++){
  ...
  console.log('plus', supplyChanges[i] ,'=');
  }
    else{
      console.log('minus', Math.abs(supplyChanges[i]) ,'=');
    }
  console.log(sum);
}
